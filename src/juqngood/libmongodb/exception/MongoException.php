...
namespace juqngood\libmongodb\exception;

final class MongoException extends \Exception {
	...
	public static function fromArray(array $exception) : MongoException {
		$class = $exception['class'] ?? MongoException::class;
